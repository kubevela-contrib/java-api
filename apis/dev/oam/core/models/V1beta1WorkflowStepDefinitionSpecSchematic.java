 ...
 */
@ApiModel(description = "Schematic defines the data format and template of the encapsulation of the workflow step definition. Only CUE schematic is supported for now.")
...
public class V1beta1WorkflowStepDefinitionSpecSchematic {
  ...
  public V1beta1WorkflowStepDefinitionSpecSchematic cue(V1beta1WorkflowStepDefinitionSpecSchematicCue cue) {
  ...
  **/
  ...
  public V1beta1WorkflowStepDefinitionSpecSchematic terraform(V1beta1WorkflowStepDefinitionSpecSchematicTerraform terraform) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1beta1WorkflowStepDefinitionSpecSchematic v1beta1WorkflowStepDefinitionSpecSchematic = (V1beta1WorkflowStepDefinitionSpecSchematic) o;
    return Objects.equals(this.cue, v1beta1WorkflowStepDefinitionSpecSchematic.cue) &&
        Objects.equals(this.terraform, v1beta1WorkflowStepDefinitionSpecSchematic.terraform);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta1WorkflowStepDefinitionSpecSchematic {\n");

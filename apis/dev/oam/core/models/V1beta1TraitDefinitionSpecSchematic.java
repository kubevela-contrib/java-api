 ...
 */
@ApiModel(description = "Schematic defines the data format and template of the encapsulation of the trait. Only CUE and Kube schematic are supported for now.")
...
public class V1beta1TraitDefinitionSpecSchematic {
  ...
  public V1beta1TraitDefinitionSpecSchematic cue(V1beta1WorkflowStepDefinitionSpecSchematicCue cue) {
  ...
  **/
  ...
  public V1beta1TraitDefinitionSpecSchematic terraform(V1beta1WorkflowStepDefinitionSpecSchematicTerraform terraform) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1beta1TraitDefinitionSpecSchematic v1beta1TraitDefinitionSpecSchematic = (V1beta1TraitDefinitionSpecSchematic) o;
    return Objects.equals(this.cue, v1beta1TraitDefinitionSpecSchematic.cue) &&
        Objects.equals(this.terraform, v1beta1TraitDefinitionSpecSchematic.terraform);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta1TraitDefinitionSpecSchematic {\n");
